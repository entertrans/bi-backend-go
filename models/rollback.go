...
func (RB_Test) TableName() string {
	return "RB_Test"
}

type RB_TestSoalRelasi struct {
...
func (RB_TestSoalRelasi) TableName() string {
	return "RB_Test_soal"
}

type RB_Peserta struct {
	...
	// Relasi
	Test  RB_Test `json:"test" gorm:"foreignKey:TestID;references:TestID"`
...
func (RB_Peserta) TableName() string {
	return "RB_Peserta"
}

type RB_JawabanFinal struct {
	...
	Session RB_TestSession `gorm:"foreignKey:SessionID;references:SessionID;constraint:OnDelete:CASCADE;"`
	Soal    RB_Banksoal `gorm:"foreignKey:SoalID;references:SoalID;constraint:OnDelete:CASCADE;"`
}

func (RB_JawabanFinal) TableName() string {
	return "RB_JawabanFinal"
}

type RB_Banksoal struct {
...
func (RB_Banksoal) TableName() string {
	return "RB_Banksoal"
}

type RB_Lampiran struct {
...
func (RB_Lampiran) TableName() string {
	return "rb_Lampiran"
}

type RB_TestSoal struct {
...
// TableName specifies the table name
func (RB_TestSoal) TableName() string {
	return "RB_Testsoal"
}

type RB_TestSession struct {
...
// Explicit table name
func (RB_TestSession) TableName() string {
	return "to_RB_TestSession"
}
